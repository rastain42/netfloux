      ...
      <li class="nav-item-down dropdown">
        ...
        >
          <li>
            ...
            <hr style="color: #fff" />
            <router-link class="dropdown-item" to="/List">
              <span style="font-size: 14px; color: #fff">Ma liste</span>
            </router-link>
          </li>
          <li>
            <router-link class="dropdown-item" to="/List">
              <span style="font-size: 14px; color: #fff">Mon compte</span>
            </router-link>
          </li>

          <li>
            <a class="dropdown-item" href="#" @click.prevent="logout">
              <span style="font-size: 14px; color: #fff">Déconnexion</span>
            </a>
          </li>
        </ul>
      </li>
