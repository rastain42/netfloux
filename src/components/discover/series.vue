<template>
  <div class="gunun-populer-dizi">
    ...
    >
      <swiper-slide v-for="dayPopularTV in dayPopularTV" :key="dayPopularTV.id">
        <div class="ms-2 me-2 movie_card item">
          ...
          <div class="film_info" v-if="isAuthenticated">
            <div class="list-icon-left">
              ...
              <a @click="addFavorite(dayPopularTV)"
