  ...
  methods: {
    async showDetail(favori) {
      ...
      try {
        await axios
          .get(
            `https://api.themoviedb.org/3/movie/${favori.id}?api_key=b8da754884cd3ae20d385db99b95ff93&language=en-US&append_to_response=videos,credits,release_dates,similar`
          )
          .then((response) => {
